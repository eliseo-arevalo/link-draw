...
import type { Drawing, DrawingTreeNode, DrawingLink } from "@/shared/types/drawing";
...
describe('LinkService', () => {
  ...
  describe('extractLinksFromCanvas', () => {
    it('should delegate to canvas adapter', () => {
      const mockLinks: DrawingLink[] = [{ elementId: 'e1', targetDrawingId: 'd2', targetType: 'drawing' }];
